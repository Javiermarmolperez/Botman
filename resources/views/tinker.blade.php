...
<script>
    var botmanWidget = {
        introMessage: 'Bienvenido al ChatBot más inteligente del mundo',
        placeholderText:'Escribe aquí ..',
        bubbleAvatarUrl:'https://i.postimg.cc/tCbjTdD8/bot2.jpg',
        title:'Botman',
        frameEndpoint:'chat',
        //desktopHeight:'400',
        //desktopWidth:'600',
        mainColor: '#819FF7',
        bubbleBackground: '#819FF7',
        aboutText:'Design by RenegadosTeam',
    };
    $(document).on('click', '.desktop-closed-message-avatar img', function() {
        ...
        iframe.addEventListener('load', function () {
            ...
            var image = "https://i.postimg.cc/tTWVd0wX/backgroundchat.jpg"
